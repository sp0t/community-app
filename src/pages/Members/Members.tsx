...
const Members = () => {
  return (
    <>
      <Breadcrumb pageName="Member Activity Analysis" />
  
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <CardDataStats title="Total Members" total="360" rate="">
          <svg
        ...
        <CardDataStats title="Active Members" total="340" rate="">
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Inactive Members" total="20" rate="">
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
